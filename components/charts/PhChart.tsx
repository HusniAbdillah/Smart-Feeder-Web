      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={280}>
          <LineChart data={chartData} margin={{ top: 8, right: 16, left: -20, bottom: 0 }}>
            ...
            />
            <Legend content={<PhLegend />} />
            
            <ReferenceLine y={7.0} stroke="#0EA5E9" strokeDasharray="3 3" label={{ position: 'insideTopLeft', value: 'Ideal 7.0', fill: '#0EA5E9', fontSize: 10 }} />
            <ReferenceLine y={8.5} stroke="#0EA5E9" strokeDasharray="3 3" label={{ position: 'insideBottomLeft', value: 'Ideal 8.5', fill: '#0EA5E9', fontSize: 10 }} />
